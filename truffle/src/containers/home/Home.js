...
import catatumba from "../../assets/img/catatumba.png";
...
const HomepageHeading = ({ mobile }) => (
  <Container text>
    ...
    <Header
      as="h2"
      content="A coin to fund the post-production and 
      distribution of the Blitz Project"
      inverted
      style={{
...
class Home extends Component {
  render() {
    ...
    const data = {
      labels: ["You", "Raised", "Goal", "Cap"],
      datasets: [
        {
          data: [
            balance,
            this.props.stats.weiRaised - balance,
            this.props.stats.cap - this.props.stats.goal,
            this.props.stats.goal - this.props.stats.weiRaised
          ],
          backgroundColor: ["#FF6384", "#36A2EB", "#FFCE56", "#4842f4"],
          hoverBackgroundColor: ["#FF6384", "#36A2EB", "#FFCE56", "#4842f4"]
        }
      ]
    };
    return (
      <ResponsiveContainer>
            ...
            <Grid.Row>
              <Grid.Column width={8}>
                ...
                <p style={{ fontSize: "1.33em" }}>
                  The Blitz Project is a documentary that accompanies artist
                  Julius von Bismarck and his team to the remote region of Lake
                  Maracaibo, Venezuela. This region is known for the world's
                  highest frequency of thunderstorms.
                </p>
               
                <p style={{ fontSize: "1.33em" }}>
                  Here, Julius wants to create lightning sculptures and
                  immortalize them via large scale photographs. The artist has
                  developed rockets to shoot into the storm clouds. These
                  rockets can reach a height of up to 800 meters, have an
                  aluminum tip and are connected to the ground through a fine
                  silver-coated kevlar thread. Bismarck’s goal is to attract
                  lightning bolts and direct them straight down the line into a
                  predetermined entry point on a floating platform in the middle
                  of the lake. Julius’ goal is to defeat one of the greatest
                  forces of nature is.
                </p>
                <p style={{ fontSize: "1.33em" }}>
                  Can this work out? The films follows this expedition with a
                  scientific, philosophical and artistic mission.
                </p>
              </Grid.Column>
              <Grid.Column floated="right" width={6}>
                <Embed id="203098041" placeholder={catatumba} source="vimeo" />
              </Grid.Column>
            </Grid.Row>
            <Grid.Row>
          ...
          <Grid celled="internally" columns="equal" stackable>
            <Grid.Row textAlign="center">
              <Grid.Column style={{ paddingBottom: "5em", paddingTop: "5em" }}>
                <Header as="h3" style={{ fontSize: "2em" }}>
                  {!!this.props.network ? this.props.network.msg : ""}{" "}
                </Header>
                <p style={{ fontSize: "1.33em" }}>
                  With id: {!!this.props.network ? this.props.network.id : ""}
                </p>
              </Grid.Column>
              <Grid.Column style={{ paddingBottom: "5em", paddingTop: "5em" }}>
                <Header as="h3" style={{ fontSize: "2em" }}>
        ...
        <Segment style={{ padding: "8em 0em" }} vertical>
          <Grid container stackable verticalAlign="middle">
            <Grid.Column width={4}>
              <Header as="h3" style={{ fontSize: "2em" }}>
                Only some are left. What are you waiting for?
              </Header>
            </Grid.Column>
