...
const BlitzCrowdsale = artifacts.require('BlitzCrowdsale');
const BlitzCrowdsaleToken = artifacts.require('BlitzCrowdsaleToken');
const RefundVault = artifacts.require('RefundVault');

contract('BlitzCrowdsale', function ([owner, wallet, investor]) {
  ...
  beforeEach(async function () {
    ...
    this.token = await BlitzCrowdsaleToken.new({ from: owner });
    this.vault = await RefundVault.new(wallet, { from: owner });
    this.crowdsale = await BlitzCrowdsale.new(
